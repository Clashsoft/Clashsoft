...
- [Clashsoft/meanstream](https://github.com/Clashsoft/meanstream) (2 months ago) - Extensions for the MEAN stack (MongoDB, (Express), Angular, Node/NestJS), especially code sharing and integration.
- [sekassel-research/vscode-collab-plugin](https://github.com/sekassel-research/vscode-collab-plugin) (3 months ago) - Collaborative editing plugin for VSCode/code-server/fulib.org Projects
