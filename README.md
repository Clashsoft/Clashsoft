...
- [ds-ukassel/backup-clickhouse-native-s3](https://github.com/ds-ukassel/backup-clickhouse-native-s3) (5 days ago) - Script for backing up clickhouse to s3 compatible storage like minio using native formats
