...
- [Clashsoft/nestx](https://github.com/Clashsoft/nestx) (5 days ago) - Stuff that is not in NestJS but should be
- [sekassel-research/thesis-template](https://github.com/sekassel-research/thesis-template) (5 days ago) - Vorlage für Dokumentationen und Abschlussarbeiten
...
- [angular/angular](https://github.com/angular/angular) ([15.2.0-next.0](https://github.com/angular/angular/releases/tag/15.2.0-next.0), 5 days ago) - The modern web developer’s platform
