...
- [fujaba/fulib.org](https://github.com/fujaba/fulib.org) ([v1.9.1](https://github.com/fujaba/fulib.org/releases/tag/v1.9.1), today) - The fulib.org website and Fulib Scenarios web app.
- [fujaba/fulib](https://github.com/fujaba/fulib) ([v1.6.1](https://github.com/fujaba/fulib/releases/tag/v1.6.1), today) - Fulib is a library that provides code generation for UML like models and some model management functionalities.
