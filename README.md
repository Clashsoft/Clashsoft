...
- [ds-ukassel/backup-clickhouse-s3](https://github.com/ds-ukassel/backup-clickhouse-s3) (3 weeks ago) - Node/Docker tool to backup Clickhouse to S3/MinIO using builtin &#34;BACKUP TABLE&#34;. Supports incremental backups.
...
- [keycloak/keycloak](https://github.com/keycloak/keycloak) ([26.3.1](https://github.com/keycloak/keycloak/releases/tag/26.3.1), 1 day ago) - Open Source Identity and Access Management For Modern Applications and Services
- [fujaba/fulibFeedback](https://github.com/fujaba/fulibFeedback) ([vscode/v1.2.0](https://github.com/fujaba/fulibFeedback/releases/tag/vscode/v1.2.0), 3 weeks ago) - IDE plugins for grading fulib.org Assignments.
