...
- [ds-ukassel/backup-mongodb-s3](https://github.com/ds-ukassel/backup-mongodb-s3) (2 months ago) - Script/Docker tool to backup MongoDB to S3/MinIO using mongodump
