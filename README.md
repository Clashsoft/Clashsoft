...
- [fujaba/fulibFeedback](https://github.com/fujaba/fulibFeedback) ([intellij/v1.2.2](https://github.com/fujaba/fulibFeedback/releases/tag/intellij/v1.2.2), 2 weeks ago) - IDE plugins for grading fulib.org Assignments.
- [fujaba/fulib.org](https://github.com/fujaba/fulib.org) ([v2.0.1](https://github.com/fujaba/fulib.org/releases/tag/v2.0.1), 4 weeks ago) - The fulib web app: fulibScenarios, fulibWorkflows, Docs, Projects and Assignments in one app.
