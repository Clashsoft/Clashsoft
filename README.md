...
- [hostwithquantum/setup-mc](https://github.com/hostwithquantum/setup-mc) (5 days ago) - A github action to download minio client (mc) in your workflows.
...
- [ds-ukassel/backup-clickhouse-native-s3](https://github.com/ds-ukassel/backup-clickhouse-native-s3) (2 months ago) - Script for backing up clickhouse to s3 compatible storage like minio using native formats
...
- [hostwithquantum/setup-mc](https://github.com/hostwithquantum/setup-mc) ([v1.2.0](https://github.com/hostwithquantum/setup-mc/releases/tag/v1.2.0), 5 days ago) - A github action to download minio client (mc) in your workflows.
