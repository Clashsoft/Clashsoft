...
- [ds-ukassel/backup-clickhouse-native-s3](https://github.com/ds-ukassel/backup-clickhouse-native-s3) (1 day ago) - Script for backing up clickhouse to s3 compatible storage like minio using native formats
- [ds-ukassel/backup-mongodb-s3](https://github.com/ds-ukassel/backup-mongodb-s3) (1 day ago) - Script/Docker tool to backup MongoDB to S3/MinIO using mongodump
