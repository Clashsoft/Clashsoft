...
- [fujaba/fulib.org](https://github.com/fujaba/fulib.org) ([v2.0.1](https://github.com/fujaba/fulib.org/releases/tag/v2.0.1), 2 days ago) - The fulib web app: fulibScenarios, fulibWorkflows, Docs, Projects and Assignments in one app.
- [fujaba/fulibFeedback](https://github.com/fujaba/fulibFeedback) ([vscode/v1.2.2](https://github.com/fujaba/fulibFeedback/releases/tag/vscode/v1.2.2), 2 days ago) - IDE plugins for grading fulib.org Assignments.
